...
<head>
  ...
  <link rel="stylesheet" href="{{asset(__Admin__)}}/plugin/layui/css/layui.css"  media="all">
...
<script src="{{asset(__Admin__)}}/plugin/layui/layui.js" charset="utf-8"></script>
...
layui.use(['upload', 'element', 'layer'], function(){
  ...
  upload.render({ //允许上传的文件后缀
    ...
    ,accept: 'file' //普通文件
    ,exts: 'zip|rar|7z|doc|docx' //只允许上传压缩文件
    ,done: function(res){
      layer.msg('上传成功');
      console.log(res)
    }
